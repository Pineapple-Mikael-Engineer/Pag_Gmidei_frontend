      ...
      <div className="bg-white rounded-2xl shadow-sm p-6">
        ...
        {recentReports.length === 0 ? <p className="text-gray-400 text-center py-8">No hay reportes aún.</p> : (
          <div className="space-y-3">
            {recentReports.map((r) => (
              <Link key={r.id} href={`/dashboard/reports/view?id=${r.id}`} className="flex items-center justify-between p-3 rounded-lg hover:bg-gray-50 transition border border-gray-100">
                <div>
