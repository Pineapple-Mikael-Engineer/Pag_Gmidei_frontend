  ...
  return (
    <div className="page-shell space-y-6">
      <div className="card bg-gradient-to-r from-white to-slate-50/80">
        ...
        <p className="text-sm text-slate-500">Gestión de proyectos, miembros y reportes asociados.</p>
      </div>
      ...
      <div className="card space-y-3">
        ...
        <div className="grid md:grid-cols-3 gap-2">
          ...
          <input className="input" placeholder="Código (ej. TURTLEBOT)" value={code} onChange={(e) => setCode(e.target.value)} />
      ...
      {canManageProject && projectId && (
        <div className="card space-y-2">
          ...
          <div className="flex gap-2">
            <input className="input flex-1" placeholder="correo@uni.pe" value={email} onChange={(e) => setEmail(e.target.value)} />
            <button className="btn-primary px-3" onClick={async () => {
              try {
        ...
        <div className="card divide-y">
          ...
          {members.map((m) => (
            <div key={m.userId} className="p-4 flex items-center justify-between gap-3">
              ...
              {canManageProject && (
                <div className="flex gap-2">
                  <button className="btn-secondary text-xs px-2 py-1" onClick={async () => {
                  ...
                  <button className="border border-red-300 text-red-700 rounded-xl px-2 py-1 text-xs hover:bg-red-50" onClick={async () => {
